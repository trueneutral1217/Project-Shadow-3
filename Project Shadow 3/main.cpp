...
void update(GAMESTATE& gameSTATE, Animation& splash, float& deltaTime, Player& player, Button& button1, Button& button2, Button& button3, Button& button4,bool& quit) {
...
void render(SDL_Renderer* renderer,GAMESTATE& gameSTATE,Animation& splash,Player& player, Button& button1, Button& button2, Button& button3, Button& button4, float& deltaTime) {
...
int main(int argc, char* args[]) {
 ...
 // SoundManager::getInstance().loadMusic("background", "background.mp3");
    ...
    while (!quit) {
        ...
        update(gameSTATE,splash,deltaTime,player,button1,button2,button3,button4,quit);
        render(renderer,gameSTATE,splash,player,button1,button2,button3,button4,deltaTime);
        endTick = SDL_GetTicks();
